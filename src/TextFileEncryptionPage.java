...
// the page where text file encryption takes place.
// works very similarly to the VideoEncryptionPage, so view the comments in that
// page to have a better understanding to the code.
// this page does not need a second file location to place the encrypted text since
// the encrypted text will be stored in the original text file

public class TextFileEncryptionPage implements ActionListener {
	...
	TextFileEncryptionPage(){
		
		textEncryptionPage = new JFrame("Text File Encryption Page");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == submit) {
			try {
				textEncryptionPage.dispose();
				TextFileEncryption.mainMethod(textFile.getText(), password.getText());
				EncryptionSuccess display = new EncryptionSuccess(textFile.getText(), 
						null);
