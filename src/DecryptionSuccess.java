...
// this class will be displayed if decryption is successful, providing the 
// location of the final decrypted file

public class DecryptionSuccess implements ActionListener {
	...
	DecryptionSuccess(String message, String finalResult){
		...
		text.setText("File: " + message + " was successfully decrypted.");
		if(finalResult != null) {
