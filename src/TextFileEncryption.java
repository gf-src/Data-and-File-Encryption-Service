...
/*
 * this class works very similarly to EncryptText, but the text is encrypted from a
 * text file one line at a time as opposed to all at once. once the line of text is 
 * encrypted, it is returned to the original text file before moving on the the next 
 * line.
 */

public class TextFileEncryption {

	public static void mainMethod(String fileName, String userKey) throws 
	NoSuchAlgorithmException, InvalidKeySpecException, IOException, InvalidKeyException, 
	...
	public static String lineEncryption(String originalLine, SecretKey key) 
	    ...
	    byte[] encryptedBytes = cipher.doFinal(originalLine.getBytes(StandardCharsets.UTF_8));
